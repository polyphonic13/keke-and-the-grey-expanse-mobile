...
namespace Polyworks {
	public class Game : MonoBehaviour {
		...
		public string saveNameList = "dimi_save_name_list.dat";
		public string saveNamePrefix = "dimi_game_data_"; 
		...
		public virtual void Save() {
			...
			DataIOController.Save (Application.persistentDataPath + "/" + currentSaveName, Instance.gameData);
		}

		public virtual void Load() {
//			GameData data = _dataIOController.Load (Application.persistentDataPath + "/" + saveNamePrefix);
		...
		public virtual void LevelInitialized() {
